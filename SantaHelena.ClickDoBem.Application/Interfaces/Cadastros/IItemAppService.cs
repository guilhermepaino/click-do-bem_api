...
namespace SantaHelena.ClickDoBem.Application.Interfaces.Cadastros
{
    public interface IItemAppService : IAppServiceBase
    {
        ...
        void ExecutarMatch(Guid id, Guid? valorFaixaId, out int statusCode, out object dadosRetorno);
        void EfetivarMatch(Guid matchId, out int statusCode, out string mensagem);
    }
}
